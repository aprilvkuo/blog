...
| 示例 | 主题 | 难度 | 核心概念 |
|------|------|------|----------|
| [01-HelloAgent](01-HelloAgent) | 第一个 Agent | ⭐ | Agent, Runtime, Message |
| [02-发布订阅](02-发布订阅) | 发布/订阅模式 | ⭐⭐ | Topic, Subscription, 广播 |
| [03-消息路由](03-消息路由) | 条件路由 | ⭐⭐ | match, @rpc, @event |
...
### 第一步：理解基础（1-2 小时）
1. 阅读 [01-HelloAgent](01-HelloAgent)
2. 运行代码并观察输出
3. 修改代码实验不同行为

### 第二步：深入理解（2-3 小时）
1. 学习 [02-发布订阅](02-发布订阅) 和 [03-消息路由](03-消息路由)
2. 理解 RPC vs 广播的区别
3. 尝试添加新的路由规则
